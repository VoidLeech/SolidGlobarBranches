...
@Mixin(Spindlefern0Block.class)
public abstract class Spindlefern0Mixin extends FlowerBlock implements BonemealableBlock {
    public Spindlefern0Mixin(Supplier<MobEffect> effectSupplier, int p_53513_, Properties p_53514_) {
