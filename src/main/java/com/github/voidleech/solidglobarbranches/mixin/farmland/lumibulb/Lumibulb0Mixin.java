...
@Mixin(Lumibulb0Block.class)
public abstract class Lumibulb0Mixin extends FlowerBlock implements BonemealableBlock {
    public Lumibulb0Mixin(Supplier<MobEffect> effectSupplier, int p_53513_, Properties p_53514_) {
